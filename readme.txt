...
This Power BI project focuses on sales analysis. The project aims to provide insights into the sales performance and market trends of a company that has stores across the country. This contains several key tables: Customers, Dates, Products, Transactions etc.,
...
- Market comparison: Interactive charts that allow for the comparison of sales across different regions.
